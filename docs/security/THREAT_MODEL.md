...
|---|---|---|---|
| Browser -> API: malicious site reads or mutates private state | S/I/T/E | Host/Origin/cross-site/peer guard; HTTP boundary regression | Local process bypass of browser headers; R-03 |
