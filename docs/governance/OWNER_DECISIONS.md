...
| OD-003 | 2026-09-13 | Integrate Release Governance v1 with the frozen release, push it, and open a PR without merging. | Completed | Governance is rebased on `81ad2d3` and PR #28 is open; merge remains a separate Owner decision after ADR review. |
