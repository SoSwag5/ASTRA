...
| C-010 | A local `hardening/l2-r13-r14` worktree briefly had uncommitted changes, while governed v1.1 work is explicitly not started. | Left that worktree untouched. At final verification the primary worktree was clean on `master` at the frozen release commit. | Resolved; v1.1 remains NOT STARTED. |
